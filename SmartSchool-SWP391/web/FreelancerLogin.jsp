<%-- 
    Document   : FreelancerLogin
    Created on : Jun 21, 2022, 12:05:28 AM
    Author     : TrinhNgocBao
--%>
              ...
              <div class="row g-0">
                <div class="col-lg-6">
                  <div class="card-body p-md-5 mx-md-4">
                    ...
                    <div class="text-center">
                      ...
                      <input type="hidden" name="isFreelance" value="isFreelance">
                ...
                <div class="col-lg-6 d-flex align-items-center rounded-end gradient-custom-2">
                  <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                    ...
                    <img src="assets/img/freelance_login.png" alt="Freelance Img" width="100%">
                  </div>
                </div>
              </div>
            </div>
