            ...
            <section class="shop" style="min-height: 82vh;">
                ...
                <div class="container">
                    ...
                    <div class="row mb-3 justify-content-center text-center">
                        <c:if test="${!empty requestScope.SUCCESSMESSAGE}">
                            <div class="alert alert-success d-flex align-items-center col-md-3 justify-content-center" role="alert">
                        ...
                        <c:if test="${!empty requestScope.ERORMESSAGE}">
                            <div class="alert alert-danger d-flex align-items-center col-md-4 justify-content-center" role="alert">
