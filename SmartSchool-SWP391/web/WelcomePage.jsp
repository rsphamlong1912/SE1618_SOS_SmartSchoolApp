<%-- 
    ...
    Created on : Jun 20, 2022, 4:12:10 PM
    Author     : TrinhNgocBao
--%>
            ...
            <section style="padding-top: 1rem;">
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center" style="min-height: 90vh;">
                        ...
                        <h1 class="fw-bold text-light text-center hero-title" style="font-family: 'Inter', sans-serif; ; color: #ffffff;
                            ...
                            1px 30px 60px rgba(16,16,16,0.4); top: 7.5rem;"> Welcome to </br>FPT
                            SmartSchool</h1>
                        <div class="row text-center">
                            <div class="col-6 text-center"> <a class="btn btn-primary btn-lg primary-btn-shadow gradient-custom-2"
                                                               style="box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;" href="lostAndfoundhome"
                            ...
                            <c:if test="${!empty sessionScope.LOGIN_USER}">
                                <c:choose>
                                    <c:when test="${sessionScope.LOGIN_USER.roleId=='EM'}">
                                        <div class="col-6 text-center"> <a class="btn btn-primary btn-lg primary-btn-shadow gradient-custom-2"
                                                                           style="box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px;" href="employerhome"
                                                                           role="button">Tìm kiếm việc Freelance</a>
                                        </div>
                                    </c:when>    
                                    <c:otherwise>
