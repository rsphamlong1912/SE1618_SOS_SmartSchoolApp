                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="product">
                          <div class="image">
                            <img
                              src="https://img.icons8.com/external-icongeek26-linear-colour-icongeek26/64/undefined/external-phone-communication-icongeek26-linear-colour-icongeek26.png"
                              alt="" />
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="product">
                          <div class="image">
                            <img src="https://img.icons8.com/external-xnimrodx-lineal-color-xnimrodx/64/undefined/external-laptop-coworking-space-xnimrodx-lineal-color-xnimrodx.png"
                              alt="" />
                          </div>
                        </div>
                      </td>
            ...
            <form action="" method="">
              <div class="row justify-content-center">
                <div class="col-11">
                  <div class="input-style-1">
                    <label>Category Name</label>
                    <input type="text" placeholder="Type here" value="Hiện title của cái đó ở đây"/>
                  </div>
                </div>
                <div class="col-11">
                  <div class="input-style-1">
                    <label>Category Image (Please copy URL Image)</label>
                    <textarea placeholder="Type here" rows="6">Hiện link</textarea>
                  </div>
                </div>
              </div>
            </form>
