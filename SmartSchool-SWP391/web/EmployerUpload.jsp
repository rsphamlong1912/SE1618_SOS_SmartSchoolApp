          ...
          <form action="main" class="needs-validation" novalidate>
            ...
            <div class="card-body pl-10 pr-10">
              <div class="form-group mb-4">
                ...
                <input type="text" name="" value="" id="title" data-validate-hide-message="1"
              ...
              <div class="form-group mb-4">
                ...
                <select name="" class="form-select form-select-lg mb-3 required" required="true" data-rule-required="true" aria-label=".form-select-lg example">
              ...
              <div class="form-group mb-4 w-50">
                ...
                <input type="number" name="" value="" id="salary" data-validate-hide-message="1"
                  class="form-control required" required="true" data-rule-required="true" data-rule-maxlength="255">
                  <div class="invalid-feedback">
                    Vui lòng nhập!
                  </div>
              ...
              <div class="form-group mb-4 w-50">
                ...
                <input type="number" name="" value="" id="amount" data-validate-hide-message="1"
                  class="form-control required" required="true" data-rule-required="true" data-rule-maxlength="255">
                  <div class="invalid-feedback">
                    Vui lòng nhập!
                  </div>
              ...
              <div class="form-group mb-4">
                ...
                <div class="row mb-3">
                  <div class="input-group">
                    <input type="text" name="" class="form-control m-input" required>
