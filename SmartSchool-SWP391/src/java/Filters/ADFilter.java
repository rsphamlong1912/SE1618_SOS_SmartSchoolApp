...
public class ADFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("ADFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("ADFilter:DoAfterProcessing");
        }
...
//        String url=req.getRequestURI();
        //nếu đã login và có vai trò là admin
//        String url = req.getServletPath();

            if (userRole.equals("AD")) {

            } else if (userRole.equals("US")) {//nếu chưa login hoặc ko phải vai trò admin
...
//                                res.sendRedirect(req.getContextPath() + "/EmployerHome.jsp");
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("ADFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("ADFilter(");
