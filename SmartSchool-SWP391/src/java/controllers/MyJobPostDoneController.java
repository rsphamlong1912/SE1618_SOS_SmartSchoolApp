 ...
 */
@WebServlet(name = "MyJobPostDoneController", urlPatterns = {"/myJobPostDone"})
public class MyJobPostDoneController extends HttpServlet {
     ...
     */
    private static final String ERROR = "EmployerJobDone.jsp";
    private static final String MY_JOB_POST_DONE_PAGE = "EmployerJobDone.jsp";
