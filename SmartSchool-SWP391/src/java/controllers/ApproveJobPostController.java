 ...
 * @author TQK
 */
@WebServlet(name = "ApproveJobPostController", urlPatterns = {"/approveJobPost"})
public class ApproveJobPostController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/Admin/ApprovePostFreelanceJob.jsp").forward(request, response);
        }
    }
