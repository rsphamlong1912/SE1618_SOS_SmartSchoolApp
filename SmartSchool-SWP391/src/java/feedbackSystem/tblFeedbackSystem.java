 ...
 */
public class tblFeedbackSystem {
    ...
    public tblFeedbackSystem() {
    }

    public tblFeedbackSystem(int feedbackId, String userId, String feedbackDesc, byte[] feedbackImg, Date dateFeedback) {
